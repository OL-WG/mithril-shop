...
function showCheckout() {
    ...
    if(isJarvis) {
        document.getElementById('check-promo-info').innerText = "Промокод: JARVIS (Скидка 15%)";
    } else {
        document.getElementById('check-promo-info').innerText = "";
    }
...
function showCart() { showCart() } // Вызывается из функции switch
